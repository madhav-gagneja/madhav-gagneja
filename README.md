...
<img src="assets/branding/mg-logo.png" width="110" alt="MG logomark"/>
...
|---|---|
| `ROLE` | AI/ML Engineer |
| `INTERNSHIP` | Graphura — AI Intern |
| `SIMULATIONS` | Deloitte · Goldman Sachs |
| `FOCUS` | AI Job Intelligence Platform |
| `NEXT ORBIT` | MADSTUD *(future)* |

![Domain](https://img.shields.io/badge/AI-0D1117?style=flat-square&labelColor=0D1117&color=00D9FF)
![Domain](https://img.shields.io/badge/ML-0D1117?style=flat-square&labelColor=0D1117&color=00D9FF)
![Domain](https://img.shields.io/badge/DATA-0D1117?style=flat-square&labelColor=0D1117&color=B366FF)
![Domain](https://img.shields.io/badge/CLOUD-0D1117?style=flat-square&labelColor=0D1117&color=B366FF)
![Domain](https://img.shields.io/badge/SECURITY-0D1117?style=flat-square&labelColor=0D1117&color=00FF9D)
...
<!--
  ...
  regenerated daily and committed to this repo as a static SVG. This
  replaces the old github-readme-stats.vercel.app / top-langs calls,
  which broke when that shared public instance was paused (Jan 2026).
  No external service to go down — this file lives in your own repo.
-->

<div align="center">

<img src="assets/metrics/github-metrics.svg" width="100%" alt="GitHub metrics: contributions, languages, activity"/>

<br/><br/>

<!-- Streak Stats kept external — streak-stats.demolab.com is a separate,
     independently-hosted service and was NOT part of the outage. -->
<img src="https://streak-stats.demolab.com?user=madhav-gagneja&theme=tokyonight&hide_border=true&background=0D1117&stroke=00D9FF&ring=B366FF&fire=00FF9D&currStreakLabel=00D9FF" />
...
<!--
  plugin_achievements is currently disabled in metrics.yml — it throws
  "Unexpected error" on lower-activity accounts (known upstream issue).
  Re-enable it there once commit/repo history has grown; this section
  will then reference the same assets/metrics/github-metrics.svg above.
-->

<div align="center">

<sub>Achievements plugin will populate here once repo/commit history grows enough for it to render reliably — see note in <code>metrics.yml</code>.</sub>
